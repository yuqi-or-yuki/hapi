...
export function SessionHeader(props: {
    ...
    const { archiveSession, reopenSession, renameSession, suggestSessionTitle, updateSessionSummary, setPinMode, deleteSession, cloneSession, isPending } = useSessionActions(
        api,
        session.id,
